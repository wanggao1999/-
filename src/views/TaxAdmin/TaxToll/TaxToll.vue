...
<template>
  <div>
    <el-card id="card">
      ...
      <div slot="header" class="clearfix card_header">
        ...
        <div class="invoiceNumber">
          <el-input v-model="dataparams.invoiceNo" placeholder="发票号码"></el-input>
        </div>
      ...
      <div>
        ...
        >
          ...
          <el-table-column align="center" prop="buyerName" label="购方名称"></el-table-column>
          ...
          <el-table-column align="center" label="操作" width="300px">
            <template slot-scope="{row}">
              ...
              <el-button size="mini" icon="el-icon-edit" type="success" @click="handlEdit(row)">编辑</el-button>
    ...
    <!-- 详情 -->
  <tollDialog :DetailVisible="DetailVisible" @TollChang="TollChang"/>
    <!-- 编辑 -->
...
<script>
import tollDialog from '@/components/dialogs/tollDialog.vue'
export default {
  mounted(){
